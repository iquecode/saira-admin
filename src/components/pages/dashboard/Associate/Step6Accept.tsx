...
export default function Step6Accept({user, setCurrentStep}:AssocieteProps) {
...
{/* 
            ...
            <p className="mt-8 mb-8 font-semibold">Você já é uma pessoa associada :)</p>
            
            {/* <div className="flex w-full justify-center text-brandOrange-500 font-semibold">
                
                        ACEITO. VOCÊ É PESSOA ASSOCIADA.
            </div> */}
        </div>
    </>  
    )
