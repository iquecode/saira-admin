...
import { getDataDBtoForm, populateFormWithDataUser } from "../../dashboard/Associate/helper";
...
export function InfoForm({user, onlyRead=false}:InfoFormProps) {
    ...
    <div className="p-1 sm:p-6 w-full text-justify bg-whitedark:bg-zinc-800 dark:border-gray-700 font-normal text-gray-700 dark:text-gray-300">
